    ...
    <div class="container grid grid-cols-5 gap-6 pt-4 pb-16 items-start">
        ...
        <script>
            ...
            <div class="grid grid-cols-1 gap-6 py-4 px-5 items-start">
                <h1 class="text-4xl font-bold text-primary">{{$property->description->title}}</h1>
            </div>
                ...
                <table class="border rounded-lg overflow-hidden w-full">
                    ...
                    <tr>
                      <td class="py-4 px-4 align-top">
                        ...
                        {{$property->detail->bathrooms}} Bathrooms<br>

                      </td>
                      <td class="py-4 px-4 align-top">
                        {{optional ($property->amenity)->balcony}}
                        Balcony<br>
                        
                        {{optional ($property->amenity)->gym}}
                            Gym<br>
                        
                        {{optional ($property->amenity)->pool}}
                            Pool<br>
                        
                        {{optional ($property->amenity)->parking}}
                            Parking<br>
                        
                        {{optional ($property->amenity)->security}}
                            Security<br>
                        
                        {{optional ($property->amenity)->pets_allowed}}
                            Pets Allowed<br>
                        
                      </td>
                      <td class="py-4 px-4 align-top">
                        ₱{{ optional($property->rate)->monthly_rate }}
                      </td>
                    </tr>
                </table>
            </div>
